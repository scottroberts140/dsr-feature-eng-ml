...
class Preferences:
    ...
    hp_short_names: dict[str, str] = field(
        default_factory=lambda: {
            ...
            "max_iter": "Max Iter",
            "random_state": "Seed",
            "optimization_strategy": "Opt Strat",
            "task_type": "Task",
            "scoring": "Metric",
            "min_weight_fraction_leaf": "Min WtLf",
            "max_leaf_nodes": "Max Nodes",
            "min_impurity_decrease": "Min Imp",
            ...
            "use_label_encoder": "Use Label Enc.",
            "use_lable_encoder": "Use Label Enc.",
            "use_lable_encoded": "Use Label Enc.",
        }
    )
